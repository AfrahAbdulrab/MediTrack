  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // ✅ FIX: Pehle purana user ka SARA data clear karo
        // Ye hi root cause tha — naye user ko purana data dikh raha tha
        ...
        console.log('🧹 Old user data cleared from AsyncStorage');

        // ✅ Ab naye user ka data save karo
